      ...
      <div id={PAGE_KEYS.SEND_MESSAGE} className='send-us-message-bg h-[45rem] form-send-us-message'>
        <div className='xl:w-[30.375rem] xl:mx-[12.5rem] lg:mx-20 mx-4 xl:py-20 py-4'>
          <div className='flex gap-4 mb-5'>
            <span className='text-[1.75rem] leading-[2.375rem] text-white uppercase'>{t('Contact us')}</span>
            <div className='h-9'>
          ...
          <form ref={form} onSubmit={handleSubmit} className='flex flex-col space-y-2'>
            ...
            <label className=' mt-2'>{t('Phone Number')}</label>
            <input
              type='text'
            ...
            <button
              className='cursor-pointer bg-[#70baa4] text-white font-light py-3 px-4 rounded uppercase text-lg hover:bg-[#5e9d8a]'
              type='submit'
            >
              {t('Send Message')}
            </button>
